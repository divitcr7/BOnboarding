...
export { default as ChevronUp1 } from './ChevronUp1';
...
export { default as HomeParking } from './HomeParking';
export { default as HomeRent } from './HomeRent';
...
export { default as MultiHome } from './MultiHome';
